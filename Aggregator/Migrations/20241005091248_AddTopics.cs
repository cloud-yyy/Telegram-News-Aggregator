    ...
    public partial class AddTopics : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TopicChannel", x => new { x.ChannelId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_TopicChannel_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TopicChannel_Topics_TopicId",
                        column: x => x.TopicId,
